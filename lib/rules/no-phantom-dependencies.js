...
module.exports = {
  meta: {
    type: "problem",
    docs: {
      description: "Make sure no phantom dependencies are used in your project.",
    },
    messages: {
      NoPhantomImport:
        '"{{packageName}}" is a phantom dependencies in your project. Please add it to "package.json".',
    },
    schema: [
      {
        type: "object",
      ...
      VariableDeclaration(node) {
        node.declarations.forEach((item) => {
          ...
          if (
            ...
            const packageName = stripImportPathParams(
